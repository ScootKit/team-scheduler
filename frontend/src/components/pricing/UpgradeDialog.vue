    ...
    >
      ...
      <div class="tw-mb-4 tw-flex tw-flex-col tw-items-start tw-gap-4">
        ...
        <div class="tw-text-sm tw-font-medium tw-text-dark-gray">
          ...
          >
            Upgrade to schedule events with WannPassts. Your payment helps us keep
            the site running.
          </template>
          <template
            v-else-if="
            ...
            "
          >
            Create unlimited events with WannPassts Premium. Your payment helps us
